...
CREATE TABLE state (
    state_state_name VARCHAR2(100) NOT NULL
);

ALTER TABLE state ADD CONSTRAINT state_pk PRIMARY KEY ( state_state_name );
...
ALTER TABLE policy
    ADD CONSTRAINT policy_state_fk FOREIGN KEY ( state_name )
        REFERENCES state ( state_state_name );
